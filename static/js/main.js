/*
 * EducDim — main.js
 * Works with the IDs/classes in base.html and home.html.
 * Complete with EducDim visual direction + mobile floating menu
 */
(function () {
  "use strict";
  ...
  function initEducDim() {
    ...
    // ============================================
    document.querySelectorAll("#mainNav a, .footer-container a").forEach(function (link) {
