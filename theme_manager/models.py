...
class Theme(models.Model):
    ...
    # ===== SITE INFO =====
    logo = models.ImageField(upload_to='theme/', blank=True, null=True, verbose_name="Logo")
    favicon = models.ImageField(upload_to='theme/', blank=True, null=True, verbose_name="Favicon")
    ...
    hero_image = models.ImageField(upload_to='theme/hero/', blank=True, null=True, verbose_name="Image Hero")
    ...
    evenement_banner = models.ImageField(upload_to='theme/evenements/', blank=True, null=True, verbose_name="Bannière événement")
    evenement_nom = models.CharField(max_length=200, blank=True, default="", verbose_name="Nom événement")
    evenement_logo = models.ImageField(upload_to='theme/evenements/', blank=True, null=True, verbose_name="Logo événement")
