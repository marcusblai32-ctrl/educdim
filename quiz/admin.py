...
class QuestionInline(admin.TabularInline):
    ...
    fieldsets = (
        ...
        ('Média de la question', {
            'fields': ('q_media_titre', 'q_media_audio_url', 'q_media_audio_file', 'q_media_video_url', 'q_media_video_file', 'q_media_image_url', 'q_media_image_file', 'q_media_texte'),
            'classes': ('collapse',)
        }),
    )
...
class QuizAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Média du Quiz', {
            'fields': ('media_titre', 'media_audio_url', 'media_audio_file', 'media_video_url', 'media_video_file', 'media_image_url', 'media_image_file', 'media_texte'),
            'classes': ('collapse',)
        }),
    )
